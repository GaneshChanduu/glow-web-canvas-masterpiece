      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 order-1 lg:order-2">
            ...
            <h3 className="about-animate opacity-0 text-3xl md:text-4xl font-bold">I'm a passionate developer who loves creating meaningful web experiences</h3>
            <p className="about-animate opacity-0 text-muted-foreground">
              I specialize in building modern, responsive, and user-friendly web applications using the latest technologies. With a strong foundation in both frontend and backend development, I create seamless digital experiences that solve real problems.
            </p>
            <p className="about-animate opacity-0 text-muted-foreground">
              My journey in web development began over 3 years ago, and since then I've worked on a variety of projects ranging from simple landing pages to complex full-stack applications. I'm constantly learning and adapting to new technologies and methodologies.
            </p>
